%% Quick script to compute the average of the budget terms over some time window for the moisture and theta_l variances 

clear variables % clear the mem
